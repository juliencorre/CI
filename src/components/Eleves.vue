...
function initialisation() {
  ...
  variables.myModal = new bootstrap.Modal('#exampleModal', {
    keyboard: false
  });
  ...
  <li class="list-group-item" v-for="eleve in eleves.eleves">
    <div class="d-flex w-100">
      ...
      <div class="" style="width:100px">
        <button class="btn pt-0 pb-0 " v-on:click="showEditerEleve(eleve)"><i class="bi bi-pencil" style=" color: #0d6efd;"></i></button>
        <button class="btn pt-0 pb-0" v-on:click="deleteEleve(eleve)"><i class="bi bi-trash" style=" color: #0d6efd;"></i></button>
      </div>
    </div>
  </li>
